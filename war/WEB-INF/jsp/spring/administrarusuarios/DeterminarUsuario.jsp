...
<div id="moreperinfo" style="display:none">
    <table border="0" cellspacing="0" width="100%" align="center" style="background-color:#FFFDF4; border:1px solid #FFE7CE">
        <tr>
            <td style="padding-top:5px; padding-bottom:5px; padding-left:5px; padding-right:5px">
                <table border="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="normal"><b>Telefonos:</b></td>
...
<table border="0" cellspacing="0">
    <tr>
        <td class="normal"><img alt="" src="./images/user.gif"></td>
        <td class="normal"><b>DATOS DE USUARIO</b></td>
    </tr>
</table>
<p class="normal">La siguiente informacion es muy <font color="red"><b>importante</b></font>, pues permite autorizar a una persona el acceso al sistema mediante un <b>c&oacute;digo</b> y un <b>PIN</b>
    complete los datos necesarios en el siguiente formulario para crear la cuenta.
</p>
<form id="nuevacuenta" name="nuevacuenta" action='<c:url value="/setregistrarusuario.do"/>'>
    <table id="lyId_usuario" border="0" cellspacing="0" width="80%" align="center" style="background-color:#FDFFEF; border:1px solid #FFE7CE">
        <tr>
            <td style="padding-top:30px; padding-bottom:30px; padding-left:30px; padding-right:30px">
                <table border="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="normal" colspan="2">Ingrese un <b>Nuevo ID</b> del usuario, el <b>sistema</b> verificar&aacute; la disponibilidad del mismo.<br> El ID deber&aacute; ser de 4 o mas caracteres.</td>
                    </tr>
                    <tr>
                        <td class="normal" width="30%"><b>Nuevo ID:</b></td>
                        <td class="normal"><input type="text" class="campo" name="id_usuario" id="id_usuario" style="width:220px" maxlength="32"></td>
                    </tr>
                    <tr>
    ...
    <br>
    <table id="lyClave" border="0" cellspacing="0" width="80%" align="center" style="background-color:#FDFFEF; border:1px solid #FFE7CE">
        <tr>
            <td style="padding-top:30px; padding-bottom:30px; padding-left:30px; padding-right:30px">
                <table border="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="normal" colspan="2">Ingrese la <b>Clave</b> del usuario, este parametro permite la autentificaci&oacute;n del usuario en el <b>sistema</b>.</td>
                    </tr>
                    <tr>
                        <td class="normal" width="30%"><b>Clave/Password:</b></td>
                        <td class="normal"><input type="password" class="campo" name='clave' id="clave" style="width:220px" maxlength="16" onBlur="verifyKey()">
                            <input id="ckbPass" type="checkbox" onClick="setViewPass()">Mostrar (Firefox)</td>
                    </tr>
                    <tr id="rowVerifyField" style="visibility:hidden">
                        <td class="normal" width="30%">Repetir la Clave</td>
                        <td class="normal"><input type="password" class="campo" name="clave2" id="clave2" style="width:220px" maxlength="16" onBlur="verifyKey()"></td>
                    </tr>
                    <tr>
                        <td class="normal" width="30%"></td>
    ...
    <br>
    <table id="lyRoles" border="0" cellspacing="0" width="80%" align="center" style="background-color:#FDFFEF; border:1px solid #FFE7CE">
        <tr>
            <td style="padding-top:30px; padding-bottom:30px; padding-left:30px; padding-right:30px">
                <table border="0" cellspacing="0">
                    <tr>
                        <td class="normal" colspan="2">Seleccione la opcion de <b>Rol</b> para el usuario, el usuario tendra acceso a las funcionalidades de cada rol del <b>sistema</b> seleccionado<br></td>
                    </tr>
                    <tr>
                        <td class="normal" style="width:110px"><b>Seleccione Rol:</b></td>
                        <td class="normal">
                            <!-- JESUS antes
                            <table border="0" cellspacing="0" cellpaddign="0" width="100%">
                                <tr>
                                    <td class="normal"><input name="roles" value="sisp" type="checkbox"> Administrador de Sistema
                                </tr>
                                <tr>
                                    <td class="normal"><input name="roles" value="tra" type="checkbox"> Funcionario Tr
                                </tr>
                                <tr>
                                    <td class="normal"><input name="roles" value="ver" type="checkbox"> Funcionario Verificador
                                </tr>
                            </table>
                            -->
                            <!-- ahora-->
                            <table border="0" cellspacing="0" width="100%">
                                <tr>
                                    <td class="normal"><input type="radio" name="ops" value="adm"> Administrador de Sistema </td>
                                </tr>
                                <tr>
                                    <td class="normal"><input type="radio" name="ops" value="usarea"> Usuario Area Desconcentrada</td>
                                </tr>
                                <tr>
                                    <td class="normal"><input type="radio" name="ops" value="zuc" checked> Usuario Proyectos</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
    ...
    <div id="msgError" style="display:none">
        <table border="0" cellspacing="0" width="80%" align="center" style="background-color:#FDFFEF; border:1px solid RED">
            <tr>
                <td style="padding-top:3px; padding-bottom:3px; padding-left:30px; padding-right:30px">
                    <table border="0" cellspacing="0">
                        <tr>
                            <td class="normal" align="center"><img alt="" src="./icon_error.gif"> Se han encontrado <b>errores</b> en el formulario, por favor revise los datos introducido e intente guardar nuevamenete.</td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <table border="0" cellspacing="0" align="center">
        <tr>
            <td colspan="2" align="center" class="normal">
                ...
                <input class="button" type="button" value="Guardar informacion" style="font-weight:bold" onclick='sendForm()'>
            </td>
        </tr>
    </table>
</form>
