...
//            }
//
//            function pdfdisponibilidad() {
////                alert('Entrando');
//                var params = 'codtar=' + "";
//                var url = '<c:url value="/reporteZucListaGeneralesPdf.do"/>';
...
//            Ajax.Responders.register(globalCallbacks);
    ...
    <body>
        ...
        <!--<div class="msgStatus" id="status"><center><img src='images/loading.gif' border='0' align='absmiddle'>Procesando tu solicitud.</center></div>-->
        
        <br>
        <table width="163" border="1" align="center">
            <tr>
                <td><div align="right"><a href="javascript:popUp('<c:url value="/reporteZucListaGeneralesPdf.do"></c:url>')" class="myButton" id="espn">Reporte Gra. Caja y Bancos</a></div></td>
                    <!--<td><div align="right"><a href="javascript:pdfdisponibilidad()"  class="myButton" id="espn" >Ver Otros Reportes</a></div></td>-->
                </tr>
            </table>
            <div id="content">
