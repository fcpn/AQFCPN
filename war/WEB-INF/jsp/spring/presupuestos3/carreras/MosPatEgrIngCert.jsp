    ...
    <body>
        <div id="container">
            <div id="content">
                <table align="center">
                    <tr>
                        <th colspan="4"><div align="center">.: Elaborar Certificaci&oacute;n Presupuestaria :.</div></th>
                    </tr>
                    <%int i = 0;%>
                    <c:forEach var="i" begin="0" end="${Fcl-1}">
                        ...
                        <c:if test="${M[i][2]==3}">
                            <%i++;%>
                            <tr onMouseOver="this.style.backgroundColor='#DBB3AE';" onMouseOut="this.style.backgroundColor='#ffffff';" >
                                <td width="22"><div align="center"><%= i%></div></td>
                                <td width="29">Tarea</td>
                                <td width="86">
                                    <div align="center">
                                        <a  href="javascript:popUp('<c:url value="/certcert1.do">
                                                <c:param name="codtar" value="${M[i][0]}"/>
                                                <c:param name="descripcion" value="${M[i][1]}"/>
                                            </c:url>')"><c:out value="${M[i][0]}"/> </a>
                                    </div>
                                </td>
                                <td width="398">
                                    <a href="javascript:popUp('<c:url value="/certcert1.do">
