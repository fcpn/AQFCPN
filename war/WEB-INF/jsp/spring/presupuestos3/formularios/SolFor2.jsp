        ...
        <div id="container">
            <div id="content">
                    ...
                    <c:if test="${!empty mensaje}">
                        <div id="failure" style="position: absolute; border: 1px solid #FFCC00; padding: 5px; background-color: #FFFFAE;">
                            <table>
                                <tr>
                                    <td>
                                        <span style="color: #000000; font-size: 10pt; font-weight: bold">&nbsp;<c:out value="${mensaje}"/>.&nbsp;&nbsp;
                                            <button style="width:50px" class="button-normal" onclick="document.getElementById('failure').style.display = 'none'">Cerrar</button>
                                        </span>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <form name="form1" method="post" action="<c:url value="/SolFor3.do"/>">
                        <table width="811" height="180" border="1">
                            ...
                            <c:forEach var="g" items="${lista_cert}" varStatus="status">
                                <tr>
                                    ...
                                    <!--partida -->
                                    <td>
                                        <span><c:out value="${g.codmonegr}"/> </span >
                                        <input type="hidden" name="idd" value="<c:out value="${g.id}"/>">
                                        <input type="hidden" name="codmonegrs" value="<c:out value="${g.codmonegr}"/>">
                                    </td>
                                </tr>
                                <% i++;%>
                            </c:forEach>
