...
<table width="523">
    <tr>
      <th colspan="2" ><div align="center">Modificar Ejecuciones Ingresos </div></th>
    </tr>
    <tr>
...
<tr>
    ...
    <td><div align="right">
	<a href=<c:url value="/ModSoloEje.do">
...
<c:forEach var="moo" items="${montos_ref}">
    ...
    <tr>
        ...
        <td><div align="right"><a href=<c:url value="/ModRefEje.do">
               ...
               </c:url>>Modificar</a></div></td>
        <td>

<a  target="mainFrame"  onClick="confirma('<c:url value="/EliRefEje.do">
                   <c:param name="codtar" value="${tarea.codtar}"/>
                   <c:param name="codacti" value="${actividad.codacti}"/>
                   <c:param name="codfueneco" value="${codfueneco}"/>
                   <c:param name="codmoning" value="${codmoning}"/>
