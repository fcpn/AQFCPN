...
<%int i=0;%>
    ...
    <td width="86"><div align="center"><span class="Estilo1"><a  href="<c:url value="/ModClasificador1.do">
                       <c:param name="codtar" value="${g.codigo}"/>
                       <c:param name="descripcion" value="${g.descripcion}"/>

                   </c:url>">
                <c:out value="${g.codigo}"/> </a></span></div></td>
    <td width="398"><span class="Estilo1"><a  href="<c:url value="/ModClasificador1.do">
                       <c:param name="codtar" value="${g.codigo}"/>
                       <c:param name="descripcion" value="${g.descripcion}"/>
