...
.Estilo10 {color: #003399; font-size: 12px; font-weight: bold; }
    ...
    <body>
        ...
        <form name="form1" method="post" action="  <c:url value="/InsertarNoPreIngSubGrupo.do"/>"">
            <div class="topdentro">
                <div align="center">
                                        ...
                                        <table width="637" height="287" border="3" align="center" >
                                            <tr>
                                                <td width="623" ><table width="200" border="0" align="center">
                                                        <tr>
                                                            <td colspan="4"><div align="center"><span class="Estilo6 Estilo2"> <span class="Estilo1">Nuevo SubGrupo -- (Cuentas No Presupuestarias) --</span> </span></div></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="4"><div align="center">
                                                                    <blockquote>
                                                                        <p class="Estilo1"><br>
                                                                        Ud eligió el grupo [<c:out value="${grup.cod_gnp}"/> - <c:out value="${grup.descripcion}"/> ]</p>
                                                                    </blockquote>
                                                            </div>                                                              </td>
                                                        </tr>
                                                        <tr bgcolor="#DFDABD">
