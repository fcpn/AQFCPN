...
<html>
    ...
    <div id="container">
<div id="content">
        <form name="form1" method="post" action="<c:url value="/InsertarMNPI4.do"/>" >
                    ...
                    <table width="602">
                        <tr>
                          ...
                          <table width="616" align="center">
                                    <tr>
                                      <th colspan="7"><div align="center">Insertar Montos No Presupuestados Ingresos</div></th>
                            </tr>
                                    <tr>
                                        <th>Actividad</th>
                           ...
                           <tr>
                           <td height="34" colspan="6"><input name="obs" type="text" id="obs" value="Saldo inicial" size="60"></td>
                                    </tr>
                                    <tr>
                                        <th width="101" rowspan="3">&nbsp;</th>
                                        <th colspan="3">Saldos a la fecha</th>
                                        <th colspan="4">&nbsp;</th>
                                    </tr>

									 <tr>
                                        <td width="46" align="center"><div align="center">
