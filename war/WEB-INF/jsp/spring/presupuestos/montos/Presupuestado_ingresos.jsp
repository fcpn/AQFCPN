...
.Estilo5 {font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; font-size: 10px; }
    ...
    <body> 
        <form name="form1" method="post" action="<c:url value="InsertarPresupuestado.do"/>" ">
              <div class="topdentro"> 
                <div align="center"> 
                    <br>
                    ...
                    <tr bgcolor="#4B4625" width="230">
                                        <td colspan="7"><div align="center" class="Estilo2">Insertar Montos a Ingresos</div></td>
                                    </tr>
                                        ...
                                        <td height="44" colspan="7"><font size="3"><strong>
                                                    <select name="codigo">
                                                        ...
                                                        <input type=hidden name=tipo value='<c:out value="${g.tipo}"/>'>
                                                         ...
                                                         <c:if test="${g.tipo == '2'}">
                                                             <c:if test="${g.codigo == '15200'}">
                                                               <option value="<c:out value="${g.tipo}"/>::<c:out value="${g.codigo}"/>"><c:out value="${g.codigo}"/> - <c:out value="${g.descripcion}"/></option>
                                                             </c:if>
                                                          </c:if>

                                                               <c:if test="${g.tipo == '2'}">
                                                             <c:if test="${g.codigo == '12200'}">
                                                               <option value="<c:out value="${g.tipo}"/>::<c:out value="${g.codigo}"/>"><c:out value="${g.codigo}"/> - <c:out value="${g.descripcion}"/></option>
                                                             </c:if>
                                                          </c:if>
                                                               <c:if test="${g.tipo == '2'}">
                                                             <c:if test="${g.codigo == '12100'}">
                                                               <option value="<c:out value="${g.tipo}"/>::<c:out value="${g.codigo}"/>"><c:out value="${g.codigo}"/> - <c:out value="${g.descripcion}"/></option>
                                                             </c:if>
                                                          </c:if>
                                    ...
                                    <tr>
                                        <td height="39" colspan="4" bgcolor="#DAD5B6"><font size="3"><strong>
                                          <select name="codfueneco">
                                            ...
                                            <option value="<c:out value="${fe.codfueneco}"/>"><c:out value="${fe.codfueneco}"/> - <c:out value="${fe.descripcion}"/> 
											</c:forEach>
                                        ...
                                        <td colspan="3" bgcolor="#DAD5B6"><input name="monpreing" type="text" size="8"></td>
                                    </tr>
                                    <tr>
              				...
              				<td bgcolor="#B4B4B4" class="Estilo5"><div align="left">Dia </div></td>
                                        ...
                                        <td width="164" bgcolor="#BDB47D"><input name="sal" type="radio" value="a" checked>
				...
				<td colspan="4" bgcolor="#B4B4B4">
                                    ...
                                    <tr>
									<td height="34" colspan="4" bgcolor="#DAD5B6"><input name="cbte" type="text" id="cbte" value="NA" size="20"></td>
                                      <td colspan="3" bgcolor="#DAD5B6"><input name="glosa_s" type="text" id="glosa_s" value="Saldos de Caja y Bancos al la fecha" size="50"></td>
                                    </tr>
                                    <tr>
                                      <td colspan="4">&nbsp;</td>
                                      <td colspan="2">&nbsp;</td>
