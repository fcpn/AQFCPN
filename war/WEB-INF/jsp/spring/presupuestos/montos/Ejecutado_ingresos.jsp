...
.Estilo7 {font-size: 24px}
    ...
    <body> 
        <form name="form1" method="post" action="<c:url value="InsertarEjecutados.do"/>">
            <div class="topdentro"> 
                <div align="center"> 
                    <br>
                        ...
                        <tr>
                            <td width="499"><table width="483" border="0" align="center">
                                    <tr bgcolor="#4B4625" width="230">
                                        <td colspan="7"><div align="center" class="Estilo2"><span class="Estilo1">Insertar Montos <span class="Estilo7">Ejecutados</span> a Ingresos</span></div></td>
                                    </tr>
