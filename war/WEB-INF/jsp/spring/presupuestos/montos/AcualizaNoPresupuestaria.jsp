...
<html>
    ...
    <body>
        <div id="container">
<div id="content">
        <h3>Lista Montos no Presupuestados Ejecutados</h3> <br>
            ...
            <c:forEach var="mo" items="${mosmoneje}">
                <c:if test="${mo.codtar==tarea.codtar }">
                    <tr>
                        ...
                        <td><div align="right"><c:out value="${mo.monejenopre}"/></div></td>
                    </tr>
                </c:if>
            </c:forEach>
        ...
        <form name="form1" method="post" action="<c:url value="/ActualizaNoP.do"/>">
                        ...
                        <tr>
                            <td width="586">
                                <table width="586" align="center">
                                    <tr>
                                        <th colspan="3"><div align="center">Actualiza Montos No Presupuestados Ingresos</div></th>
                                    </tr>
                                    <tr>
                                   ...
                                   <tr>
                                        <td>
                                        <input name="monto" type="text" size="8"></td>
                                        <td>
                                        <input name="comprobante" type="text" id="comprobante" size="40"></td>
