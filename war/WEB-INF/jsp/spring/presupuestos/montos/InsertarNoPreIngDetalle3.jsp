...
.Estilo10 {color: #003399; font-size: 12px; font-weight: bold; }
    ...
    <body>
        <form name="form1" method="post" action=" <c:url value="/InsertaNPID3.do"/>" ">
              <div class="topdentro">
                <div align="center">
                                        ...
                                        <table width="637" height="287" border="3" align="center" >
                                            <tr>
                                                <td width="623" ><table width="200" border="0" align="center">
                                                        <tr>
                                                            <td colspan="4"><div align="center"><span class="Estilo6 Estilo2"> <span class="Estilo1">Nuevo Detalle   </span></span></div></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3" width="523">
                                                                ...
                                                                <div align="center">
                                                                    ...
                                                                    <p class="Estilo1"><br><br> Ud. eligió el SubGrupo Detalle [<c:out value="${subgrupo.cod_snp}"/> - <c:out value="${subgrupo.descripcion}"/>]</p>
                                                        ...
                                                        <tr bgcolor="#DFDABD">
                                                            <td><div align="center"><span class="Estilo1">
                                                                        ...
                                                                        <!--***********VARIABLES*********-->
                                                                        <input name="codigo" type="text" id="codigo" size="8" maxlength="20" border="ffccff">
                                                            </span></div></td>
                                                            <td colspan="3"><div align="left"><span class="Estilo1">
                                                                        <input name="descripcion" type="text" id="descripcion" size="55">
                                                                        
                                                                        <input type=hidden name=cod_snp value='<c:out value="${subgrupo.cod_snp}"/>'>
