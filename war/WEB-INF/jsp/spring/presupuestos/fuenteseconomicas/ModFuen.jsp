...
<html>
	...
	<div id="container">
<div id="content">
 <form name="form1" method="post" action="<c:url value="/ModFuen2.do"/>">
...
<table width="200" border="0" align="center">
  ...
  <tr>
    <th>Codigo</th>
    <td>
      <input name="codfueneco2" type="text" id="codfueneco2" value="<c:out value="${cod}"/>">    </td>
  </tr>
  <tr>
    <th>Descripcion</th>
...
<input name="codfueneco" type="hidden" value="<c:out value="${codfueneco}"/>">
