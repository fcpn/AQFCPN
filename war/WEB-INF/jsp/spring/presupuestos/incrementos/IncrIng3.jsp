...
.Estilo8 {
    ...
    <body>
        ...
        <form name="form1" method="post" action="<c:url value="/IncrIng4.do"/>">
            <table width="523" border="1" align="center" bordercolor="#CC9933">
                <tr bgcolor="#37321C" >
                  <td colspan="2" ><div align="center" class="Estilo4 Estilo5">Incremento de Montos [Ingresos] </div></td>
              </tr>
                <tr bgcolor="#E6E6E6" >
            ...
            <table width="861" border="1" align="center" bordercolor="#CC9933">
                ...
                <tr >
                    <td height="29" ><c:out value="${codmoning}"/> - <c:out value="${des_ref1}"/></td>
