...
<table width="523" border="1" align="center" bordercolor="#CC9933">
    <tr bgcolor="#57502B" >
      <td colspan="2" ><div align="center" class="Estilo4">Incrementos Ingresos</div></td>
    </tr>
    <tr >
...
<table width="731" border="2" align="center" bordercolor="#CC9933">
    <tr>
      <td bgcolor="#57502B"><div align="center" class="Estilo5 Estilo10">INFORME INGRESOS</div></td>
    </tr>
    <tr>
...
<c:forEach var="mo" items="${mosmoneje}">  
    ...
    <c:if test="${mo.codtar==codtar }">
        ...
        <tr>
       	...
       	<td>
		<a href=<c:url value="/IncrIng3.do">            
