...
<body>
<form name="form1" method="post" action="<c:url value="/InsertarGrupoRubro.do"/>" ">
  <div class="topdentro"> 
    <div align="center">
    ...
    <table width="637" height="287" border="3" align="center" >
      <tr>
        <td width="623" ><table width="200" border="0" align="center">
          <tr>
            <td colspan="4"><div align="center"><span class="Estilo6 Estilo2"> <span class="Estilo1">Nuevo Grupo -- (Rubro) --</span> </span></div></td>
          </tr>
          <tr>
            <td><div align="center">
                <blockquote>
