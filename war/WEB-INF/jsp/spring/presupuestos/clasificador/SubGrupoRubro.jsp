...
.Estilo4 {font-weight: bold}
    ...
    <body>
        <form name="form1" method="post" action="<c:url value="/SubGrupoRubro2.do"/>">
              <div class="topdentro"> 
                <div align="center"> 
                    <p>&nbsp;</p>
                    <table width="637" height="287" border="3" align="center" >
                        <tr> 
                            <td width="623" > <table width="674" border="0" align="center">
                                    ...
                                    <tr bgcolor="#999999">
                                        <td bgcolor="#DFDABD"><span class="Estilo3">Elija <u><strong>Grupo de Rubro</strong></u> para insertar SubGrupo --&gt;</span></td>
                                        <td colspan="3" bgcolor="#DFDABD">
                                            <select name="codgru_ru">
                                                <!--
                                                ...
                                                <c:forEach var="g" items="${grupos}">
                                                    <option value="<c:out value="${g.codgru_ru}"/>"><c:out value="${g.codgru_ru}"/> - <c:out value="${g.descripcion}"/></option>
                                                </c:forEach> 
                                        </select></td>
                                    </tr>
                                    <tr >
