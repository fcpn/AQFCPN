...
.Estilo10 {color: #003399; font-size: 12px; font-weight: bold; }
    ...
    <body>
        <form name="form1" method="post" action=" <c:url value="/InsertarRubro3.do"/>" ">
              <div class="topdentro">
                <div align="center">
                                        ...
                                        <table width="637" height="287" border="3" align="center" >
                                            <tr>
                                                <td width="623" ><table width="200" border="0" align="center">
                                                        <tr>
                                                            <td colspan="4"><div align="center"><span class="Estilo6 Estilo2"> <span class="Estilo1">Nuevo Rubro   </span></span></div></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3" width="523">
                                                                ...
                                                                <div align="center">
                                                                    ...
                                                                    <p class="Estilo1"><br><br> Ud. eligió el SubGrupo [<c:out value="${subrubro.codsub_ru}"/> - <c:out value="${subrubro.descripcion}"/>]</p>
                                                        ...
                                                        <tr bgcolor="#DFDABD">
                                                            ...
                                                            <td colspan="3"><div align="left"><span class="Estilo1">
                                                                        ...
                                                                        <input type=hidden name=codsub_ru value='<c:out value="${subrubro.codsub_ru}"/>'>
