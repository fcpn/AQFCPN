...
<html>
    <head>
        ...
        question = confirm("Eliminar el Rubro : "+ aa +" ?")
        if (question !="0"){
    ...
    <body>
        ...
        <c:forEach var="g" items="${rubros}">
            ...
            <c:if test="${g.tipo == '1'}">
              ...
              <a href="<c:url value="/modrub.do">
                            <c:param name="codmoning" value="${g.codigo}"/>
                            <c:param name="tipo" value="${g.tipo}"/>
                     </c:url>">...... [Modificar] </a> .....
             <a style="cursor: pointer; color: red;" 
                onClick="confirma('<c:url value="/EliRub.do">
                    <c:param name="codmoning" value="${g.codigo}"/>
             ...
             <a style="cursor: pointer;" onClick="confirma('<c:url value="/EliRub.do"> <c:param name="codmoning" value="${g.codigo}"/><c:param name="tipo" value="${g.tipo}"/></c:url>','<c:out value="${g.codigo}"/>'); return false;"> <font color="red">[Eliminar]</font> </a>
               <br>
              </c:if>
              <c:if test="${g.tipo == '3'}">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
