...
<table width="523" border="1" align="center" bordercolor="#CC9933">
    <tr bgcolor="#422D00" >
      <td bgcolor="#C0C0C0" ><div align="center" class="Estilo4 Estilo30">Datos Anteriores </div></td>
    </tr>
</table>
<br>
...
<table width="523" border="1" align="center" bordercolor="#CC9933">
    <tr bgcolor="#422D00" >
      <td bgcolor="#000066" ><div align="center" class="Estilo4 Estilo31">Datos Actuales Modificados </div></td>
    </tr>
</table>
<br>
<table width="812" border="1" align="center" bordercolor="#CC9933">

<tr bgcolor="#993300" class="Estilo25">
    <td colspan="5"><div align="center" class="Estilo31">Partida Actual</div></td>
  </tr>
...
<tr>
    <td align="center"><div class="montitos">
<c:out value="${modt.codmonegr}"/>


</div></td>
    <td><div class="montitos"><c:out value="${modt.codfueneco}"/> </div></td>

    <td><div align="right" class="montitos"><c:out value="${modt.montopresu}"/></div></td>
    <td><div align="right" class="montitos"><c:out value="${modt.montoeje}"/></div></td>
    <td><div align="right" class="montitos"><c:out value="${modt.saldo}"/> </div></td>
...
<table width="795" border="1" align="center" bordercolor="#CC9933">
  <tr bgcolor="#993300" class="Estilo25">
    <td colspan="6"><div align="center"><span class="Estilo25"><span class="Estilo31">&nbsp; Ejecucion de traspaso Actual </span><!---Ultimo # de comprobante-->
    </span></div></td>
  </tr>
...
<tr>
    ...
    <td width="149" bgcolor="#D6D6D6"> <span class="Estilo29"><strong>&nbsp;Fecha deTraspaso </strong> </span>
    <div align="right" class="Estilo29"></div></td>
...
<td width="95" bgcolor="#D6D6D6"><div align="center" class="Estilo29"><strong>Fuente Econ&oacute;mica</strong></div></td>
    ...
    <tr bgcolor="#C4C4C4">
 <td><div class="montitos"><c:out value="${tr.codmonegr2}"/></div></td>
      <td><div align="justify" class="montitos"><c:out value="${tr.glosa}"/></div> </td>
      <td> <div align="right" class="montitos"><c:out value="${tr.cbte}"/></div></td>
      <td><div align="right" class="montitos"><c:out value="${tr.fecha}"/></div></td>
      <td> <div align="right" class="montitos"><c:out value="${tr.monto}"/></div></td>


<td> <div align="right" class="montitos"><c:out value="${tr.codfueneco}"/></div></td>
