...
<form name="form1" method="post"  onsubmit="return confirm('¿Esta seguro de los cambios?')" action="<c:url value="/ModdIncEgr2.do"/>">
...
<tr bgcolor="#8F8F8F">
    <td colspan="2"><div align="center"><span class="Estilo25">
      <input  align="center" name="codmonegr" type="text" id="codmonegr" value="<c:out value="${codmonegr}"/>"></span></div></td>
    <td colspan="2"> <div align="center"><span class="Estilo25">
...
<input type=hidden name=codmonegr1 value='<c:out value="${codmonegr}"/>'>
