...
<table width="523" border="0" align="center" bordercolor="#CC9933" style="empty-cells:show ">
    <tr bgcolor="#003366" >
      <td colspan="2" ><div align="center" class="Estilo4">Modificar Solo Ejecutado<br>
        Egresos </div></td>
  </tr>
    <tr bgcolor="#EAEAEA" >
...
<table width="496" border="0" align="center" bordercolor="#CC9933">
  ...
  <tr >
    <td>
      <div align="center"> <c:out value="${ejeante.codmonegr}"/> </div></td>
    <td><div align="center"> <c:out value="${ejeante.codfueneco}"/></div></td>
    <td align="center" > <c:out value="${ejeante.montopresu}"/>  </td>
    <td align="center" bgcolor="#999999"> <c:out value="${moneje1}"/> </td>
    <td align="center" > <fmt:formatNumber  value="${ejeante.montopresu-moneje1}" pattern="#,###,###,##0.00"/></td>
  </tr>
  <tr bgcolor="#990000">
...
<table width="496" border="0" align="center" bordercolor="#CC9933">
  ...
  <!--  funciona   -->
  <tr>
   <td>      <div align="center"> <c:out value="${ejemodi.codmonegr}"/> </div></td>
    <td><div align="center"> <c:out value="${ejemodi.codfueneco}"/></div></td>
    <td align="center" > <c:out value="${ejemodi.montopresu}"/> </td>
	    <td align="center" bgcolor="#FFA6B8"><fmt:formatNumber  value="${ejemodi.montoeje}" pattern="#,###,###,##0.00"/> </td>
			    <td align="center"><fmt:formatNumber  value="${ejemodi.saldo}" pattern="#,###,###,##0.00"/>  </td>
  <tr bgcolor="#990000">
    <td height="3" colspan="5"></td>
  </tr>
</table>
