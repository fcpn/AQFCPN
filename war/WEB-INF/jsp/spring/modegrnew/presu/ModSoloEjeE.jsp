...
<form name="form1" method="post" action="<c:url value="/ModSoloEje2E.do"/>">
<table width="523" border="1" align="center" bordercolor="#990000">
    <tr bgcolor="#003366" >
      <td colspan="2" ><div align="center" class="Estilo4 Estilo5">Modificar Monto Ejecutado <br>
        Egresos </div></td>
  </tr>
    <tr >
...
<tr>
    ...
    <td colspan="2" bgcolor="#003D79"><div align="center"><span class="Estilo7">Partida</span></div></td>
