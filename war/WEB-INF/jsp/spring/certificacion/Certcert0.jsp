...
<div id="content">
  ...
  <tr>
    <th colspan="4" align="center"><br> Certificacion Presupuestaria <br></th>
  </tr>
<%int i=0;%>
    ...
    <td width="86"><div align="center">
	 <a  href="javascript:popUp('<c:url value="/certcert1.do">
                   ...
                   </c:url>')"> <c:out value="${g.codigo}"/></a>
	</div></td>


    <td width="398"> <a  href="javascript:popUp('<c:url value="/certcert1.do">
                       <c:param name="codtar" value="${g.codigo}"/>
                       <c:param name="descripcion" value="${g.descripcion}"/>
