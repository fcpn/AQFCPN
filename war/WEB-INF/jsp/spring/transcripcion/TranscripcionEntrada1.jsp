...
#slides_content .foto {
    ...
    height:370px; /* ALTURA DE CADA SLIDE */
    padding:10px;
...
<table id="initinfo" width="100%" cellpadding="0" border="0" style="background-color:#D5D5D5">
 <tr>
   ...
   <td class="colhpt">Nro.Tjtas Hoy</td> 
   <td class="colhpt" style="padding-left:20px; padding-right:20px; font-size: 16px; color:#7E64AB; border: 1px solid #7E64AB"><div id="nro_hoy"></div></td> 
   <td class="colhpt">Record</td> 
   <td class="colhpt" style="padding-left:20px; padding-right:20px; font-size: 16px; color:#EEEEEE; border: 1px solid #000000; background-color: orange"><div id="nro_total"></div></td> 
...
<div id="slides_content">
    ...
    <div style="width:750px;height:350px; overflow:auto">
	<img onclick='javascript:zoom("img-a");' id="img-a" title="click para zoom" alt="REPORTES" src='<c:out value="${lnombreA}"/>' border=1 width="740" height="340">
    </div>
    ...
    <div style="width:750px;height:350px; overflow:auto">
        <img onclick='javascript:zoom("img-r");' id="img-r" title="click para zoom" alt="REPORTES" src='<c:out value="${lnombreR}"/>' border=1 width="740" height="340">
    </div>
...
<%-- Lado formulario--%>
    ...
    <table width="95%" align="center">
        ...
        <td> 
        <fieldset>
            <legend class="normal">R1 :: DATOS PERSONALES</legend>  
                ...
                <table cellpadding="0" border="0" cellspacing="0">
                    <tr>
                        <td class="colhpt">Nro. Gral (CI)<input type="text" id="cedula" maxlength="10" class="funcional" name="cedula" value="<c:out value="${obj.cedula}"/>" style="width: 80px; font-size: 14px; color: #000000" align="center" onblur='enviar("cedula")' onkeypress='return val_ci(event)'></td>
...
<!--			    <input type="text" id="sexo" class="campo" name="" value="<c:out value="${obj.sexo}"/>" style="width: 70px" onblur='enviar("sexo")'> -->
			           ...
			           <option value="M" <c:if test="${obj.id_sexo == 'M'}">selected</c:if>>Masculino</option>
				   <option value="F" <c:if test="${obj.id_sexo == 'F'}">selected</c:if>>Femenino</option>
				   <option value="O" <c:if test="${obj.id_sexo == 'O'}">selected</c:if>>Sin dato</option>
                            </select>
                        </td>
                        <td class="colhpt">Libro Mat.</td>
                        <td class="normal"><input type="text" id="libro" maxlength="32" class="campo" name="libro" value="<c:out value="${obj.libro}"/>" style="width: 60px" onblur='enviar("libro")'></td>
                        <td class="colhpt">Folio</td>
                        <td class="normal"><input type="text" id="folio" maxlength="32" class="campo" name="folio" value="<c:out value="${obj.folio}"/>" style="width: 60px" onblur='enviar("folio")'></td>
                        <td class="colhpt">Revisor</td>
                        <td class="normal"><input type="text" id="revisor" maxlength="64" class="campo" name="revisor" value="<c:out value="${obj.revisor}"/>" style="width: 143px" onblur='enviar("revisor")'></td>
                </table>
            </td>
	   </tr>    
        </fieldset>
    ...
    <table width="95%" align="center">
        ...
        <td> 
        <fieldset>
            <legend class="normal">R2 :: DATOS DE PROCEDENCIA</legend>  
...
<!--	        <input type="text" id="departamento" class="campo" name="" value="<c:out value="${obj.departamento}"/>" style="width: 170px" onblur='enviar("departamento")'><br> -->
    ...
    <table width="95%" align="center">
        ...
        <td> 
        <fieldset>
            <legend class="normal">R3 :: DATOS DE NACIMIENTO</legend>  
...
<tr><td style="padding-left:5px"><img src="images/help.gif" width="16" height="16"/></td>
...
function estcivil() {
  ...
  if (!(est==3 || est==7)) {
    ...
    <table width="95%" align="center">
        ...
        <td> 
        <fieldset>
            <legend class="normal">R4 :: DATOS DE ESTADO CIVIL</legend>  
...
<tr><td style="padding-left:5px"><img src="images/help.gif" width="16" height="16"/></td>
    ...
    <table width="95%" align="center">
        ...
        <td> 
        <fieldset>
            <legend class="normal">R5 :: DATOS DE SERVICIO, PROFESIONES Y DESCRIPCION</legend>  


    <table cellpadding="0" border="0" cellspacing="0">
        <tr><td colspan="6" align="right"><table cellpadding="0" border="0" cellspacing="0"><tr>
            <td class="colhpt" style="">Estatura</td>
            <td class="normal"><input type="text" id="altura" maxlength="4" class="campo" name="" value="<c:out value="${obj.altura}"/>" style="width: 30px" onblur='enviar("altura")' maxlength="3" onkeypress='return solo_numeros_0(event)'><b>cm</b></td>
...
<!--	      <input type="text" id="grupo_sanguineo" class="campo" name="" value="<c:out value="${obj.descripcion}"/>" style="width: 50px" onblur='enviar("descripcion")' maxlength="5"> -->
	 ...
	 <tr>    
            ...
            <td class="normal"><input type="text" id="servicio_militar" maxlength="60" class="campo" name="" value="<c:out value="${obj.servicio_militar}"/>" style="width: 120px" onblur='enviar("servicio_militar")'></td>
    ...
    <table cellpadding="0" border="0" cellspacing="0">
        <tr>
            ...
            <td class="normal"><input type="text" id="senias_particulares" maxlength="256" class="campo" name="" value="<c:out value="${obj.senias_particulares}"/>" style="width: 270px" onblur='enviar("senias_particulares")'></td>
        </tr> 
    </table>	
    <table cellpadding="0" border="0" cellspacing="0">
	<tr>  
...
<table width="95%" align="center">
	...
	<td class="colhpt">Lugares donde ha residido en otros paises</td>
     ...
     <tr>
	<td class="normal"><input id="pasaporte" maxlength="16" type="text" class="campo" name="pasaporte" value="<c:out value="${obj.pasaporte}"/>" style="width: 100px" onblur='enviar("pasaporte")'></td>
	<td class="normal"><input id="pste_otorgado" maxlength="32" type="text" class="campo" name="pste_otorgado" value="<c:out value="${obj.pste_otorgado}"/>" style="width: 100px" onblur='enviar("pste_otorgado")'></td>
	<td class="normal"><input id="pste_visado"  maxlength="32" type="text" class="campo" name="pste_visado" value="<c:out value="${obj.pste_visado}"/>" style="width: 100px" onblur='enviar("pste_visado")'></td>
	<td class="normal"><input id="pste_fecha"  maxlength="32" type="text" class="campo" name="pste_fecha" value="<c:out value="${obj.pste_fecha}"/>" style="width: 100px" onblur='enviar("pste_fecha")'></td>
	<td class="normal"><input id="pste_otra_residencia"  maxlength="64" type="text" class="campo" name="pste_otra_residencia" value="<c:out value="${obj.pste_otra_residencia}"/>" style="width: 100%" onblur='enviar("pste_otra_residencia")'></td>
     </tr>
    </table>
    </fieldset>
        <fieldset>
            <legend class="normal">RE :: CAMPOS PARA EXTRANJEROS</legend>
    <table cellpadding="0" border="0" cellspacing="0">
     <tr>
	...
	<td class="colhpt">Permanencia</td>
     ...
     <tr>
	<td class="normal"><input id="nombre_supuesto"  maxlength="32" type="text" class="campo" name="nombre_supuesto" value="<c:out value="${obj.nombre_supuesto}"/>" style="width: 100px" onblur='enviar("nombre_supuesto")'></td>
	<td class="normal"><input id="nro_penal"  maxlength="16" type="text" class="campo" name="nro_penal" value="<c:out value="${obj.nro_penal}"/>" style="width: 100px" onblur='enviar("nro_penal")'></td>
	<td class="normal"><input id="nro_censo"  maxlength="16" type="text" class="campo" name="nro_censo" value="<c:out value="${obj.nro_censo}"/>" style="width: 100px" onblur='enviar("nro_censo")'></td>
	<td class="normal"><input id="radicatoria"  maxlength="64" type="text" class="campo" name="radicatoria" value="<c:out value="${obj.radicatoria}"/>" style="width: 100px" onblur='enviar("radicatoria")'></td>
	<td class="normal"><input id="permanencia"  maxlength="64" type="text" class="campo" name="permanencia" value="<c:out value="${obj.permanencia}"/>" style="width: 100px" onblur='enviar("permanencia")'></td>
     </tr>
    </table>
    </fieldset>
</table>
...
function setcurrenttime(codigo) {
      var valor = document.getElementById('tiempo').value;
      var contenttype = 'application/x-www-form-urlencoded';      
      var req = null;   
      req = AjaxHttp();
      
      req.open('GET','<c:url value="/currenttime.do"/>?tiempo='+valor, true);      
      req.setRequestHeader('Content-Type', contenttype);
      req.onreadystatechange = 
        function() { ''
           if (req.readyState == 4){
...
<script>enviarparientes();</script>
   ...
   <table cellpadding="0" border="0" cellspacing="0">
	...
	<td class="colhpt">Ubicaci&oacute;n</td>
      ...
      <tr>
        <td><input id="dom_localidad" maxlength="64" type="text" class="campo" name="" value="<c:out value="${obj.dom_localidad}"/>" style="width: 150px" onblur='enviar("dom_localidad")'></td>
        <td><input id="zona"  maxlength="64" type="text" class="campo" name="" value="<c:out value="${obj.zona}"/>" style="width: 150px" onblur='enviar("zona")'></td>
<!--        <td><input id="barrio" type="text" class="campo" name="" value="<c:out value="${obj.barrio}"/>" style="width: 80px" onblur='enviar("barrio")'></td>  -->
        <td><input id="calle"  maxlength="64" type="text" class="campo" name="" value="<c:out value="${obj.calle}"/>" style="width: 150px" onblur='enviar("calle")'</td>
        <td><input id="nro_casa"  maxlength="8" type="text" class="campo" name="" value="<c:out value="${obj.nro_casa}"/>" style="width: 40px" onblur='enviar("nro_casa")'></td>
        <td><input id="ubicacion"  maxlength="128" type="text" class="campo" name="" value="<c:out value="${obj.ubicacion}"/>" style="width: 250px" onblur='enviar("ubicacion")'></td>
      </tr>
   </table>    
            </td>
	   </tr>    
...
<!--	 <td class="colhpt">Nro. Huellas</td>
	 <td class="normal"><input id="nro_huellas_r" maxlength="2" type="text" class="campo" name="" value="<c:out value="${obj.nro_huellas_r}"/>" style="width: 30px" onblur='enviar("nro_huellas_r")' maxlength="2" onkeypress='return validarN(event)'></td>
-->	 
        </tr>
	<tr>	 
	 <td class="normal" align="right" colspan="3" style="padding-top: 10px; padding-bottom: 10px">
	  ...
	  <input id="guardartarjeta" type="button" name="" value="Guardar Tarjeta" onclick="guardar();">
	 </td> 
        </tr>
...
<!--    
<form name="crono">
<input size="8" name="display" value="00:00:0" type="text"><input name="Iniciar" value=" Iniciar " onclick="IniciarCrono()" type="button">
<input size="8" name="parcial" value="00:00:0 " type="text"> <input name="Parcial" value="Parcial" onclick="ObtenerParcial()" type="button">
<input name="Parar" value=" Parar " onclick="DetenerCrono()" type="button"> <input name="Cero" value="  Cero  " onclick="DetenerCrono(); InicializarCrono()" type="button">
</form>
-->    
</div>
...
<input id="tiempo" type="hidden" name="tiempo">
</form>
...
<tr>
  <td class="normal" align="center" style="color:#FFFFFF; padding-bottom:5px; padding-right:5px; padding-top:5px; padding-left:5px; background-color:black">
    <div id="cronometro">&nbsp;</div>
  </td>
</tr>
<tr>  
  <td align="center" style="padding-right:5px; padding-top: 2px; padding-left: 5px;">
...
<table align="center" style="background-color:#FFFFFF">
    <tr>        
       <td style="padding-left:20px; padding-top:10px;"><img src="images/loading.gif" width="15" height="15" alt="loading"/></td>
       <td class="nromal" style="font-weight:bold; font-size:16px; padding-right:20px; padding-top:10px; padding-bottom:10px; color:#000000"><div id="showcedula"></div></td>
    </tr>
</table>
</td></tr>
</table>
...
<div id="infoobs" style="position: fixed; left: 0px; top: 400px; background-color: #000000; z-index: 1">
...
<c:if test="${!empty intime}">
decimas  = 0
segundos = <c:out value="${segundos}"/>
minutos  = <c:out value="${minutos}"/>
</c:if>

//pone a cero los marcadores
//document.crono.display.value = '00:00'
//document.crono.parcial.value = '00:00'
}
...
//ValorCrono += ":" + decimas 
  ...
  document.getElementById('cronometro').innerHTML = ValorCrono   
  document.getElementById('tiempo').value = ValorCrono   
...
<script>
IniciarCrono()
setInterval('setcurrenttime()',20000);
setTimeout(getResultadosUsr,3000);
</script>
