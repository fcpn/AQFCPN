...
.Estilo10 {color: #003399; font-size: 12px; font-weight: bold; }
    ...
    <body>
        <form name="form1" method="post" action=" <c:url value="/InsertaNPED3.do"/>" ">
              <div class="topdentro">
                <div align="center">
                                        ...
                                        <table width="637" height="287" border="3" align="center" >
                                            <tr>
                                                <td width="623" ><table width="200" border="0" align="center">
                                                        <tr>
                                                            <td colspan="4"><div align="center"><span class="Estilo6 Estilo2"> <span class="Estilo1">Nuevo Detalle Egresos </span></span></div></td>
