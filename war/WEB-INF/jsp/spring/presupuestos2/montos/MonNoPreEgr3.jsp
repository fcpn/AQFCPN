...
.Estilo4 {font-weight: bold}
    ...
    <body>
        <form name="form1" method="post" action=" <c:url value="/MenuNoPreEgr2.do"/>"">
              <div class="topdentro"> 
                <div align="center"> 
                    <p>&nbsp;</p>
                                ...
                                <table width="574" border="0" align="center">
                                    <tr bordercolor="#00FF99">
                                        <td colspan="4"><div align="center" class="Estilo1 Estilo6">
                                                <h3>Montos - no - Presupuestados Egresos</h3>
                                        </div></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4"><!-- database mostrar grupo-->                &nbsp;
                                        <div align="center"><span class="Estilo1"><strong>Ud. eligi&oacute; la actividad [<c:out value="${actividad.descripcion}"/>]</strong></span></div></td>
                                    </tr>
                                    <tr bgcolor="#DFDABD">
                                        <td width="253" bgcolor="#DFDABD"><span class="Estilo3">Elija <strong><u>Tarea</u></strong> para insertar monto--&gt;</span></td>
                                        <td colspan="3"><select name="codtar">
