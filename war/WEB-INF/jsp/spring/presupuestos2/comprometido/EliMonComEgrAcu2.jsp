...
<html>
    ...
    <body>
        ...
        <form name="form1" method="post" action="<c:url value="/EliMonComEgrAcu3.do"/>">
            <table width="523" border="1" align="center" bordercolor="#CC9933">
                <tr bgcolor="#544D29" >
                    <td colspan="2" ><div align="center" class="Estilo4">Eliminar Montos Comprometidos Acumulados</div></td>
                </tr>
                <tr bgcolor="#CBC196" >
                ...
                <c:if test="${j != '-1'}">
                    ...
                    <c:forEach var="i" begin="0" end="${j}" step="9">
                        ...
                        <tr bgcolor="#CBC196">
                            ...
                            <td width="155"><span class="Estilo13">&nbsp;Glosa
                                    <!---Ultimo # de comprobante-->
                                </span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><c:out value="${M[i+4]}"/></td>
                        </tr>


                        <tr>
                            <td colspan="5" bgcolor="#CCCCCC">Se eliminaran los datos Seleccionados </td>
                        </tr>
                        <tr bgcolor="#666666">
                            <td height="19" colspan="6">
                                <input type=hidden name=complemento value='<c:out value="${M[i]}"/>::<c:out value="${M[i+1]}"/>::<c:out value="${M[i+2]}"/>::<c:out value="${M[i+3]}"/>::<c:out value="${M[i+4]}"/>::<c:out value="${M[i+5]}"/>::<c:out value="${M[i+6]}"/>::<c:out value="${M[i+7]}"/>::<c:out value="${M[i+8]}"/>'>
                            </td>
                        </tr>
