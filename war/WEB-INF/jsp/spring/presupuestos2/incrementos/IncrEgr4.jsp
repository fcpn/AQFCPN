          ...
          <tr>
            <td>			 <p align="center">&nbsp;</p>
              ...
              <table width="523" border="1" align="center" bordercolor="#CC9933">
                ...
                <tr >
                  <td ><c:out value="${codmonegr}"/> - <c:out value="${des_ref1}"/></td>
              ...
              <table width="516" border="1" bordercolor="#000066" bgcolor="#FFFFFF">
                <tr bgcolor="#000066">
                  <td width="268" bgcolor="#FFFFFF">
                           ...
                           <a href=<c:url value="/IncrEgr2.do">            
                          <c:param name="codfueneco" value="${codfueneco}"/>
                          <c:param name="codtar" value="${codtar}"/>
                          </c:url>>
                   Nuevo Incremento en la misma Fuente y Tarea </a>              </td>
                  
                   <td width="268" bgcolor="#FFFFFF">
                     
                           <a href=<c:url value="/IncrEgr.do">            
                          <c:param name="codfueneco" value="${codfueneco}"/>
                      
                          </c:url>>
                   Nuevo Incremento en la misma Fuente </a>              </td>
