...
.Estilo10 {color: #003399; font-size: 12px; font-weight: bold; }
    ...
    <body>
        <form name="form1" method="post" action="  <c:url value="/InsertarSubGrupoPartida2.do"/>"">
              <div class="topdentro">
                <div align="center">
                                                ...
                                                <td width="623" ><table width="200" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td colspan="4"><div align="center">
                                                                    <blockquote>
                                                                        <p class="Estilo1"><br>
                                                                        Ud eligió el grupo [<c:out value="${grupos.codgru}"/> - <c:out value="${grupos.descripcion}"/> ]</p>
                                                                    </blockquote>
                                                            </div>                                                              </td>
                                                        </tr>
                                                        <tr bgcolor="#DFDABD">
                                                            ...
                                                            <td colspan="3"><div align="left"><span class="Estilo1">
                                                                        ...
                                                                        <input type=hidden name=codgru value='<c:out value="${grupos.codgru}"/>'>
