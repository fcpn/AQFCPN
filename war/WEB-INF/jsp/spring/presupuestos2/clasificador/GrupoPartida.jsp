...
<body>
<form name="form1" method="post" action="<c:url value="/InsertarGrupoPartida.do"/>" ">
  <div class="topdentro"> 
    <div align="center">
    ...
    <table width="637" height="287" border="3" align="center" >
      <tr>
        <td width="623" ><table width="200" border="0" align="center">
          <tr>
            <td colspan="4"><div align="center"><span class="Estilo6 Estilo2"> <span class="Estilo1">Nuevo Grupo -- (Egresos) --</span> </span></div></td>
          </tr>
          <tr>
            <td><div align="center">
                <blockquote>
          ...
          <tr>
            ...
            <td colspan="3"><div align="center"><span class="Estilo1"> </span></div></td>
          </tr>
          <tr bgcolor="#DFDABD">
          ...
          <tr bordercolor="#00FF99" bgcolor="#BAAD74">
            <td colspan="4"><div align="center" class="Estilo6 Estilo2 Estilo3">
                ...
                <!--<div align="center"><span class="Estilo1">[<a href="javascript:history.Back()">Atras</a>]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Men&uacute; Rubro]</span><br>-->
                <div align="center"><span class="Estilo1"><!--[<a href="insertarcuentasaingresos.do">Atras</a>]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[<a href="insertarcuentasaingresos.do">Men&uacute; Rubro</a>]--></span><br>
                </div>
            </div></td>
          </tr>
          <tr>
