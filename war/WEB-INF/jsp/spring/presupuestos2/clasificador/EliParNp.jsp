...
<html>
	...
	<div id="container">
<div id="content">
 <form name="form1" method="post" action="<c:url value="/mostarpartidanopree.do"/>">
...
<table width="221" border="0" align="center">
  ...
  <tr>
    <td colspan="2"><input type="submit" name="Submit" value="Menu Partidas No Presupuestaria"></td>
  </tr>
</table>
<input name="codmoning" type="hidden" value="<c:out value="${codigo}"/>">
