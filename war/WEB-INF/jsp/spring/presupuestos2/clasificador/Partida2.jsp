...
.Estilo4 {font-weight: bold}
    ...
    <body>
        <form name="form1" method="post" action="<c:url value="/Partida3.do"/>"">
              <div class="topdentro"> 
                <div align="center"> 
                    <p>&nbsp;</p>
                                ...
                                <table width="674" border="0" align="center">
                                    <tr bordercolor="#00FF99">
                                        <td colspan="4"><div align="center" class="Estilo1 Estilo6">
                                                <h3>Nueva Partida</h3>
                                                   Ud. eligió el grupo [<c:out value="${partida.codgru}"/> - <c:out value="${partida.descripcion}"/> ]
                                    ...
                                    <tr bgcolor="#DFDABD">
                                        ...
                                        <td colspan="3"><select name="codsub">
                                                <c:forEach var="g" items="${grupos}">
                                                    <option value="<c:out value="${g.codsub}"/>"> <c:out value="${g.codsub}"/> - <c:out value="${g.descripcion}"/> </option>
