...
.Estilo4 {font-weight: bold}
    ...
    <body>
        <form name="form1" method="post" action="<c:url value="/Partida2.do"/>"">
              <div class="topdentro"> 
                <div align="center"> 
                    <p>&nbsp;</p>
                        ...
                        <tr> 
                            <td width="623" >  
                                <table width="674" border="0" align="center">
                                    ...
                                    <tr bgcolor="#DFDABD">
                                        <td bgcolor="#DFDABD"><span class="Estilo3">Elija <u><strong>Grupo Partida</strong></u> para insertar Partida --&gt;</span></td>
                                        <td colspan="3"><select name="codgru">
