...
.Estilo4 {font-weight: bold}
    ...
    <body>
        <form name="form1" method="post" action="<c:url value="/InsertarResponsable2.do"/>">
            <div class="topdentro"> 
                <div align="center"> 
                    <p>&nbsp;</p>
                        ...
                        <tr> 
                            <td width="623" >  
                                <table width="574" border="0" align="center">
                                    ...
                                    <tr bgcolor="#DFDABD">
                                        <td width="253" bgcolor="#DFDABD"><span class="Estilo3">Elija <strong><u>Programa</u></strong> &gt;</span></td>
