...
public class Transcripcion6Controlador implements Controller {
	...
	tarjeta = (Tarjeta) this.mi.getTarjeta(datos);
	tarjeta.setOcupaciones(this.mi.getOcupaciones(datos));
	tarjeta.setParientes(this.mi.getParientes(datos));
	tarjeta.setRelaciones(this.mi.getRelaciones(datos));
	tarjeta.setTramites(this.mi.getTramites(datos));
