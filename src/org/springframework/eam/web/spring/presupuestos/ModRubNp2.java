...
public class ModRubNp2 implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(tipo.equals("1"))
        {
          orm.ejecutarObjeto("clasificador", "modifica_gruponp", r, null);
        ...
        if(tipo.equals("2"))
        {
          orm.ejecutarObjeto("clasificador", "modifica_subgrunp", r, null);
          r.setCodigo(codigo2);
        ...
        if(tipo.equals("3"))
        {
          orm.ejecutarObjeto("clasificador", "modifica_rubronp", r, null);
          r.setCodigo(codigo2);
        ...
        return new ModelAndView("presupuestos/clasificador/ModRubNp2", modelo);
    }
