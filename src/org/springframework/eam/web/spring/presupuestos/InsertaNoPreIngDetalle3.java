...
public class InsertaNoPreIngDetalle3 implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        orm.ejecutarObjeto("cuentanopresuing","cod_snp",gr,gr);
        
        modelo.put("subgrupo",gr);
        
        orm.cerrar();//cerrar la conexion         ahora vamos a jsp
        return new ModelAndView("presupuestos/montos/InsertarNoPreIngDetalle3", modelo);
    }
}