...
public class ModEjeNoPreCla implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        /*Datos Anteriores*/
        String codmonnopreing = request.getParameter("cod_snp");
...
/*FIN FIN FIN FIN FIN FIN Datos Nuevo a Cambiar*/
        ...
        pre.setI_c(i_c);
       /*mostrando anterior*/
        orm.ejecutarObjeto("cuentanopresuing","saldo_inicial",pre,pre);
        modelo.put("ant", pre);

        /*Restando el valor inicial del saldo*/
        
        pre.setSaldo_ej_i(saldo_ej_i);
        orm.ejecutarObjeto("cuentanopresuing","resta_s_inicial",pre,pre);
...
orm.ejecutarObjeto("cuentanopresuing","mod_s_ini",pre,pre);
...
orm.ejecutarObjeto("cuentanopresuing","saldo_inicial",pre,pre);
 modelo.put("ant2", pre);
        ...
        return new ModelAndView("presupuestos/modifica/MuestraModNoPre", modelo);
    }
}