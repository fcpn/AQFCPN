...
public class IncrEgr4 implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        /*sumando la cantidad del monto de incremento a la cuenta en egresos*/
        
        tras r=new tras();
        r.setCodmonegr(codmonegr);      
        r.setCodfueneco(codfueneco);
        r.setCodtar(codtar);
        r.setMonto(monsum);
        orm.ejecutarObjeto("montosegreso","suma2",r,null);
        
        /*Actualizando saldos a la cuenta uno*/
        
        tras rw=new tras();
        
        rw.setCodmonegr(codmonegr);      
        rw.setCodfueneco(codfueneco);
        rw.setCodtar(codtar);
       
        orm.ejecutarObjeto("montosegreso","actualiza_saldo",rw,null);
        
        /*Sumando al campo incremento*/
        orm.ejecutarObjeto("montosegreso","sum_incre",r,null);
        System.out.println("despuest de incrementos");
       
        /***************Guardando a historial de Incrementos*****************************************************************/
        
        String i_e="1";/*0---->ingresos*/
        tras tr=new tras();
        tr.setCodmon(codmonegr);
        tr.setI_e(i_e);
    ...
    //8    int sw2=0;
        ...
        {//if_1
           ...
           {//for
                 ...
                 if(codmonegr.equals(me.getCodmoning()) && codfueneco.equals(me.getCodfueneco()) && codtar.equals(me.getCodtar()))
                {//if_2 
       ...
       /*descripcion del clasificador*/
        ...
        {//if_1
            ...
            {//for
                 Rubro pa=(Rubro) partida.get(i);
                           ...
                           if(ref1.equals(pa.getTipo()) && codmonegr.equals(pa.getCodigo()))
                           {//if_2
        ...
        return new ModelAndView("presupuestos2/incrementos/IncrEgr4", modelo);
    }
}