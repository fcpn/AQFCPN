...
public class InsertarNoPreEgrSubGrupo implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
       ...
       // gr.setCodgru_ru(codgru_ru);
        ...
        orm.ejecutarObjeto("cuentanopresuegr","inserta_subgrupo",gr,null);
        ...
        return new ModelAndView("presupuestos2/montos/MenuNoPreEgr", modelo);
    }
}