...
public class InsertarMNPE4 implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String codcod=codmonnopreegr;
        
        
        System.out.println("REV LOS SALDOS SALDOS");
        System.out.println("tipo----"+ref123);
        System.out.println("codigoclasificador----"+codmonnopreegr);
        ...
        orm.ejecutarObjeto("cuentanopresuegr","inserta_ejecutado",pre,null);
        ...
        if(sal.equals("b"))
        {
          ...
          nnp.setCodmonnopreegr(codmonnopreegr);
          nnp.setCodtar(codtar);
          nnp.setCodfueneco(codfueneco);
          nnp.setMon_acu(montoacu);
        
          orm.ejecutarObjeto("cuentanopresuegr","inserta_ejecutado_referencia",nnp,null);
        ...
        List mon=orm.ejecutarLista("cuentanopresuegr","mostrar_ejecutados",null, new MosPresuIng());
        ...
        return new ModelAndView("presupuestos2/montos/MuestraEjecutadosNoPresuE", modelo);
