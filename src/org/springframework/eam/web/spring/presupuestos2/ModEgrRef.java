...
public class ModEgrRef implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        u.setId(id);
        orm.ejecutarObjeto("montosegreso","actualiza_ejecutado_ref",u,null);
