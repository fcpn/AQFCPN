...
public class ModdIncEgr2 implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String codm=codmonegr;

        String monpre1=request.getParameter("monto1");
        String id=request.getParameter("id");
        String codmonegr1=request.getParameter("codmonegr1");
...
//Sacando el Ultimo dato insertado EL dato modificado
        ...
        orm.cerrar();
     /*88889 */
        return new ModelAndView("modegrnew/increegr/ModdIncEgr2", modelo);
    }
}